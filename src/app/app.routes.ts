...
export const routes: Routes = [
	...
	{ path: 'iscrizione/annullato',	loadComponent: () => import('./features/public/iscrizione-annullato/iscrizione-annullato').then(m => m.IscrizioneAnnullato) },
	{ path: 'donazione/successo',	loadComponent: () => import('./features/public/donazione-successo/donazione-successo').then(m => m.DonazioneSuccesso) },
	// ── Auth ──────────────────────────────────────────────────────────────
	...
	// ── Dashboard (shell + children) ──────────────────────────────────────
	{
		...
		children: [
			...
			{ path: 'services',      canActivate: [roleGuard('services')],     loadComponent: () => import('./features/private/services/services').then(m => m.Services) },
		],
	},
